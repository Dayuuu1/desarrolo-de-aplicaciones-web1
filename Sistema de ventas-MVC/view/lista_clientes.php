...
$listaclientes = $controllerC->listarCliente();
...
<body>
			...
			<div class="modal fade show" id="basicModal" style="padding-right: 15px; display: none;" aria-modal="true" role="dialog">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="../controller/ClienteController.php" method="post" autocomplete="off" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">Dni</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" name="dni" id="dni" placeholder="Ingrese dni del cliente" required>
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">Nombre</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" name="nombre_cliente" id="nombre_cliente" placeholder="Ingrese nombre del cliente" required>
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">direccion</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" placeholder="Ingrese direccion del cliente" name="direccion" id="direccion">
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">telefono</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" placeholder="Ingrese telefono del cliente" name="telefono" id="telefono">
									</div>
								</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<?php if ($_SESSION['id_rol'] == 1) { ?>
											<td>
												<a href="frm_editar" class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#edit_modal" id="cliente<?php echo $item["id_cliente"]; ?>" data-id_cliente="<?php echo $item["id_cliente"]; ?>">
													<i class="fas fa-pencil-alt"></i>
												</a>

												<a href="frmD_eliminar" class="btn btn-danger shadow btn-xs sharp btn" data-bs-toggle="modal" data-bs-target="#eliminar_modal" id="cliente<?php echo $item["id_cliente"]; ?>" data-id_cliente="<?php echo $item["id_cliente"]; ?>" data-nombre_cliente="<?php echo $item["nombre_cliente"]; ?>">
						...
						<form action="../controller/ClienteController.php" method="post" autocomplete="off" enctype="multipart/form-data">
							<div class="modal-body">
								...
								<div class="mb-3 row" style="display: none;">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" name="id_cliente_edit" id="id_cliente_edit" placeholder="Ingrese id" required>
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">Dni</label>
									<div class="col-sm-10">
										<input type="number" class="form-control form-control-sm" name="dni_edit" id="dni_edit" placeholder="Ingrese el nuevo dni" required>
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">Nombre</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" name="nombre_cliente_edit" id="nombre_cliente_edit" placeholder="Ingrese el nuevo nombre" required>
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-sm-2 col-form-label col-form-label-sm">direccion</label>
							...
							<div class="modal-body">
								<div class="mb-3 row ">
									...
									<div class="col-sm-10" style="display: none;">
										<input type="text" class="form-control form-control-sm" name="id_cliente_eliminar" id="id_cliente_eliminar" placeholder="idProducto_eliminar" required>
									</div>
									<h3>Estas seguro de querer eliminar a <span id="elimin_cliente"></span></h3>
								</div>

							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-primary " data-bs-dismiss="modal">Cerrar</button>
								<button class="btn btn-danger light" name="id_eliminar_cli" id="id_eliminar_cli">Eliminar</button>
							</div>
	...
	<script>
		...
		$(document).on('click', "a[id^=cliente]", function() {
			...
			value4 = $(this).closest('tr').find('td:eq(3)').text();

			$("#dni_edit").val(value1);
			$("#nombre_cliente_edit").val(value2);
			$("#direccion_edit").val(value3);
			$("#telefono_edit").val(value4);
